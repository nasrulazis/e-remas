    ...
    <!-- Masthead-->
        ...
        <section class="page-section" >
            <div class="container  d-flex justify-content-between">
                <h1>Edit Informasi Keagamaan </h1>
            </div>
                ...
                <div class="row">
                    <div class="col-12 p-2">
                        ...
                        <div class="card text-dark my-3 border">
                            ...
                            <form class="text-center border border-light px-5 py-2 w-100" method="post" action="{{route('editinformasiKeagamaan',$data->id)}}">
                            @csrf
                            <div class="modal-body ">
                                    <!-- Name -->
                                    <input type="text" name="judul" class="form-control mb-4" placeholder="Judul" value="{{$data->judul}}">                            
